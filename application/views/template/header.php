        ...
        <div id="globalConst">
            <div class="d-flex flex-row align-items-center">
                <div class="d-inline-flex flex-grow-1 flex-shrink-0">
                    <a href="/feed/index">
                        <img src="/static/img/logo.png" class="w100">
                    </a>
                </div>
                ...
                <div class="d-inline-flex flex-grow-1 flex-shrink-0">
                    <nav class="d-flex flex-grow-1 flex-row justify-content-end">
                        <div class="d-inline-flex me-3">
                            <a href="#" class="h24" id="btnNewFeedModal" data-bs-toggle="modal" data-bs-target="#newFeedModal">
                        ...
                        <div class="d-inline-flex dropdown">
                            <a href="#" role="button" id="navDropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false" class="header_profile">
                                ...
                                <!-- <img src="/static/img/profile/<?=$_SESSION[_LOGINUSER]->iuser?>/<?=$_SESSION[_LOGINUSER]->mainimg?>" onerror="this.onerror=null; this.src='/static/img/profile/bp.png'"> -->
                                    <img class="profileimg" src="/static/img/profile/<?=getMainImgSrc()?>" onerror="this.onerror=null; this.src='/static/img/profile/bp.png'"> 
                                </div>
                            </a>
